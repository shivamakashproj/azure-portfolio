...
```mermaid
flowchart TD
    A[💡 Portfolio Development] --> B[HTML / CSS / JS]
    B --> C[📦 Git]
    C --> D[🐙 GitHub]
    D --> E[☁️ Microsoft Azure]
    E --> F[🖥️ Azure App Service]
    F --> G[🌍 Public Live Website]
```
...
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=flat-square&logo=github&logoColor=white)](https://github.com/shivamakashproj)
